...
static intradoc.data.Workspace  ws;

public UseRIDC (intradoc.data.Workspace  ws )
...
}  // end of Constructor with work space . Which is required for DB actions 
...
}  // end of Constructor with out work space . Which is only for service not having any completebinder method like DELETE ,MOVE etc 


//public  String  useRIDCCheckin  (intradoc.data.ResultSet docInfo , String  VaultfilePath) throws Exception 

public  String  useRIDCCheckin  (intradoc.data.DataBinder binder , String  VaultfilePath) throws Exception 
...
commitstatus=4;
		...
		try{
                                 ...
                                 dataBinder = completedataBinder( dataBinder, docInfo);
                                     ...
                                     intradoc.data.ResultSet FileInfo = binder.getResultSet("FileInfo");

                                                           if (FileInfo != null)
                                                  dataBinder = completedataBinder( dataBinder, FileInfo);  
...
oracle.stellent.ridc.model.DataBinder  responseData = null;
		...
		try{
                                     ...
                                     dataBinder = FoldercompletedataBinder( dataBinder,FolderInfo);
...
public  String  fldFolderUnFile  (List<String>  targetffFolderGUID ) throws Exception 


{

traceVerbose ("in fldRemoveFolder class ");
String status="" ;
oracle.stellent.ridc.model.DataBinder  responseData = null;
		...
		try{
                                     ...
                                     dataBinder.putLocal("IdcService", "FLD_UNFILE");
                                           ...
                                           dataBinder.putLocal(item, ("path:"+targetffFolderGUID.get(k)));
                                                     itemscount++;
...
public static  oracle.stellent.ridc.model.DataBinder completedataBinder   (oracle.stellent.ridc.model.DataBinder  dataBinder , intradoc.data.ResultSet rs ) throws intradoc.common.ServiceException ,intradoc.data.DataException
                                          ...
                                          {   
                                             ...
                                             if ( key.equals("dCreateDate") || key.equals("dOutDate") || key.equals("dDocLastModifiedDate")|| key.equals("dDocCreatedDate"))
...

                                                                                       {
                                                                                                    ...
                                                                                                    if ( value.equals("FLD_ROOT"))
                                                                                                             dataBinder.putLocal(key,value);

                                                                                               else {

                                                                                                   traceVerbose("value is " + value); 

                                                                                         String targetffFolderGUID =  findfParentGUIDInTarget(value);


                                                                                            traceVerbose ( "Source "+value + "  target"+targetffFolderGUID);


                                                                                                          if ( targetffFolderGUID.length () == 0 )
                                                                                                   traceVerbose("no target fParentGUID, still updating");
                                                                                           
                                                                       

                                                                                                           else 
                                                                                             dataBinder.putLocal(key,targetffFolderGUID);
...
public static  oracle.stellent.ridc.model.DataBinder FoldercompletedataBinder   (oracle.stellent.ridc.model.DataBinder  dataBinder , intradoc.data.ResultSet rs )
...
private static   String   findfParentGUIDInTarget (String fGUID ) throws intradoc.common.ServiceException ,intradoc.data.DataException


{

   String selectSQL = "select TARGETFFOLDERGUID from PullFolderridc where FFOLDERGUID ='"+fGUID+"' and (Targetffolderguid Is Not Null AND Targetffolderguid <> 'null')" ;   
...
} //end of findfParentGUIDInTarget
