                   ...
                   String     updateSQL="CREATE SEQUENCE rid_seq START WITH     1000 INCREMENT BY   1 NOCACHE NOCYCLE";
                            insertpullRIDCTable (ws,updateSQL);
                             ...
                             insertpullRIDCTable (ws,updateSQL);
                                ...
                                updateSQL="Create Table PullFolderridc  (rid Number(7), Ffolderguid Varchar2(32), Rentrydate Number(20),Ractiondate Number(20), ridcservice Varchar2(32), Fparentguid Varchar2(32),ridcpushaction Varchar2(256),targetFFOLDERGUID VARCHAR2(32),  Commitstatus Number(3), Fparentpath Varchar2(512) ,   PRIMARY KEY (rid))";
